...
public class TravelPackageServiceController {
	...
	@GetMapping
	public List<Service> getAll(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId) {
		return travelPackageRepository.findById(travelPackageId).get().getAvailableServiceList();
	}

	@PostMapping
	public List<Service> saveAll(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId,
	...
	@PutMapping
	public List<Service> updateAll(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId,
			@RequestBody List<Service> services) {
		for (Service service : services) {
			if (!serviceRepository.findById(service.getServiceId()).isPresent()) {
	...
	@DeleteMapping
	public List<Service> deleteAll(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId) {
	...
	public Service getService(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId,
			@PathVariable("serviceId") int serviceId) {
		return serviceRepository.findById(serviceId).get();
	}

	@PutMapping("/{serviceId}")
	public Service updateService(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId,
	...
	public Service deleteService(@RequestHeader("token") String token, @PathVariable("travelPackageId") int travelPackageId,
			@PathVariable("serviceId") int serviceId) {
